...
Ezetimibe is currently not registered in Taiwan (台灣Not marketed; TFDA authorization count: 0). No approved product licenses or package inserts are available from the TFDA database at this time.

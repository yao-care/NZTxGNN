...
Letrozole currently has **zero registered authorizations** in New Zealand (`market_status: Not marketed` / not marketed; `total_licenses: 0`). No license records are available to tabulate.

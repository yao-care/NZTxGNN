...
Famotidine is currently **not marketed** in New Zealand (market status: Not marketed), and there are no active authorizations on record. No product-level licensing data is available for this indication.

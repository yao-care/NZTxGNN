...
Medroxyprogesterone Acetate is currently **not marketed** in this jurisdiction (market status: Not marketed), and no license records are available in this Evidence Pack.

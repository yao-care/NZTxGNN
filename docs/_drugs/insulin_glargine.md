...
Insulin glargine currently holds **0 authorizations** in the New Zealand regulatory dataset (market status: Not marketed / Not marketed). No license records are available to summarize.

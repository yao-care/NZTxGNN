...
Riluzole currently holds **no market authorization in New Zealand** (`market_status`: Not marketed / Not Marketed; `total_licenses`: 0). No product listings are available to summarize.

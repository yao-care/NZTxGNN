...
BASE_URL = "https://nztxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "nztxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "NZTxGNNFHIRServer",
        "title": "NZTxGNN FHIR Server - New Zealand Drug Repurposing",
        "description": "FHIR R4 server for New Zealand TxGNN drug repurposing predictions",
        "status": "active",

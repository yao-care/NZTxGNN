...
from nztxgnn.data import load_fda_drugs, filter_active_drugs
from nztxgnn.mapping import (
    map_fda_drugs_to_drugbank,
    map_fda_indications_to_diseases,
    get_mapping_stats,
    get_indication_mapping_stats,
)
from nztxgnn.predict import find_repurposing_candidates, generate_repurposing_report


def main():
    print("=" * 60)
    print("知識圖譜方法 - New Zealand藥品老藥新用預測")
    print("Drug Repurposing Prediction in New Zealand")
    print("=" * 60)
    print()

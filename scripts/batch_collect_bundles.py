...
import pandas as pd
from nztxgnn.collectors import DrugBundleAggregator
from nztxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from nztxgnn.collectors.drug_bundle import PredictedIndication
...
def patch_single_drug(
    ...
    """
    from nztxgnn.collectors.drug_bundle import DrugBundle

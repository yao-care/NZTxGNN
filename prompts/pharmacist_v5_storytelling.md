...
- `taiwan_regulatory`: Medsafe approval and market status in New Zealand
...
| New Zealand Market Status | [Extract from taiwan_regulatory.market_status] |
...
| Evidence Level | L1 |
| New Zealand Market Status | ✓ Marketed |
...
In fact, the S-1 combination has been approved in Japan and New Zealand for colorectal cancer treatment,
